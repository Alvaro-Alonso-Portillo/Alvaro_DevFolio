...
function page() {
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center">
      ...
      <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">Pagina no encontrada</p>
      <p className="mt-2 text-gray-500 dark:text-gray-400">Lo siento, la página que busca no existe.</p>
